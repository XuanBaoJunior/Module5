...
function Create() {
    ...
    const validate = {
        ...
        id: Yup.string().required("Required").matches(/^PROD-\d{4}$/, "ID không đúng định dạng, VD: PROD-0000"),
                    ...
                    ({isSubmitting}) => (
                        <Form>
                            ...
                            <div className="mb-3">
                                ...
                                <ErrorMessage name='productPrice' component='span' style={{color: 'red'}}></ErrorMessage>
                            </div>
